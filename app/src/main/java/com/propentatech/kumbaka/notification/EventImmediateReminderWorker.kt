...
/**
 * Worker pour afficher une notification de rappel 5 minutes avant un événement
 * Exécuté par WorkManager au moment planifié
 */
class EventImmediateReminderWorker(
    context: Context,
    ...
    companion object {
        ...
        const val WORK_NAME_PREFIX = "event_reminder_five_minutes_"
    }
}
